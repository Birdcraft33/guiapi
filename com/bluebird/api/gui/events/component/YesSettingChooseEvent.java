...
public class YesSettingChooseEvent extends Event{
	...
	public YesSettingChooseEvent(YesNoSettings clickedYesNoSetting, SettingOption clickedOption, HumanEntity whoClicked, Gui clickedGui, InventoryAction action, int slot, ClickType clickType) {
